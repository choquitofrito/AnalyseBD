...
<body>
    <h3>Cette page crée une connexion et obtient de données d'une BD</h3>
    <?php
    ...
    foreach ($tableau as $cle => $unAppart){
        echo "<br>".$unAppart['idAppartement'];
        echo "<br>".$unAppart['adresse'];
        echo "<br>".$unAppart['etat'];
    }
